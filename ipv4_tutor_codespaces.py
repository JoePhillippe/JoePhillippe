...
Modified for GitHub Codespaces
"""
...
# Initialize Anthropic client - READS FROM ENVIRONMENT VARIABLE
...
if __name__ == '__main__':
    print("=" * 60)
    print("IPv4 Networking Tutor - GitHub Codespaces Version")
    print("=" * 60)
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        ...
        print("Set it in GitHub Codespaces Secrets")
    else:
        print("API Key: Found!")
    
    print("=" * 60)
    print("Server starting on http://0.0.0.0:5001")
    print("Codespaces will provide a public URL")
    print("=" * 60)
    
    # Use 0.0.0.0 to allow external connections in Codespaces
